...
const Socialmediafix = () => {
  return (
    <div>
      <body>
        <div className="fixed left-0 top-1/4 z-50 px-5 py-3 bg-transparent flex flex-col space-y-3">
          <a href="#" title="Contacter nous sur Facebook">
            <svg
          ...
          <a href="#" title="Contactez nous sur WhatsApp">
            <svg
